...
![Hidden tests passed per task](docs/charts/hidden-tests.svg)
...
[one run is not a measurement](docs/variance.md#one-run-is-not-a-measurement)
...
docs/                     also published at
  ...
  harness.md              opencode vs Oh My Pi vs Claude Code vs the Java
                          harness vs DeepSeek Harness
...
results/
  ...
  dsh-measurements.json   DeepSeek Harness runs, with the two discarded
                          attempts and why they were discarded
