...
def kopf(breite, hoehe, titel):
    # Herkunftszeile: diese Dateien werden erzeugt, nicht von Hand gepflegt.
    # Wer eine davon aendern will, aendert results/*.json und laesst dieses
    # Skript laufen.
    return [
        ...
        # Innerhalb des Wurzelelements, nicht davor: ein Kommentar im Prolog ist
        # zwar gueltiges XML, aber Anzeigeprogramme, die die ersten Bytes auf
        # "<svg" pruefen, stolpern darueber. Beim Beheben eines Anzeigefehlers
        # kein neues Risiko einbauen.
        '<!-- generated by tools/charts.py from results/*.json - do not edit -->',
        f'<title>{titel}</title>',
    ]
